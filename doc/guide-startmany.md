...
### Send 1000 XMCC to New Addresses

Send exactly 1000 XMCC to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 1000 XMCC.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 1000 XMCC on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the monoeci github repo](https://github.com/monacocoin-net/monoeci-core/blob/master/doc/masternode_conf.md)
...
## Update monoeci.conf on server

If you generated a new masternode private key, you will need to update the remote `monoeci.conf` files.
...
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `monoeci.conf` file.
...
Search your Masternodes on https://monoecininja.pl/masternodes.html
