...
This document provides guidelines for internationalization of the Monoeci Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `monoeci_en.ts` remains unchanged.
