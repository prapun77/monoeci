...
official/supported Docker Images found at https://hub.docker.com/r/monacocoin-net/monoeci-cored/
...
**NOTE: Please update the image description at https://hub.docker.com/r/monacocoin-net/monoeci-cored-develop/ when changing the above text**