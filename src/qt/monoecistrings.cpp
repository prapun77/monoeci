...
#define UNUSED
#endif
static const char UNUSED *monoeci_strings[] = {
QT_TRANSLATE_NOOP("monoeci-core", "Monoeci Core"),
QT_TRANSLATE_NOOP("monoeci-core", "The %s developers"),
...
QT_TRANSLATE_NOOP("monoeci-core", "%s corrupt, salvage failed"),
QT_TRANSLATE_NOOP("monoeci-core", "%s is not a valid backup folder!"),
QT_TRANSLATE_NOOP("monoeci-core", "%s is set very high!"),
QT_TRANSLATE_NOOP("monoeci-core", "(%d could be used only on mainnet)"),
QT_TRANSLATE_NOOP("monoeci-core", "(default: %s)"),
QT_TRANSLATE_NOOP("monoeci-core", "(default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "(must be %d for mainnet)"),
QT_TRANSLATE_NOOP("monoeci-core", "(press q to shutdown and continue later)"),
QT_TRANSLATE_NOOP("monoeci-core", "-devnet can only be specified once"),
QT_TRANSLATE_NOOP("monoeci-core", "-maxmempool must be at least %d MB"),
QT_TRANSLATE_NOOP("monoeci-core", "-port must be specified when -devnet and -listen are specified"),
QT_TRANSLATE_NOOP("monoeci-core", "-rpcport must be specified when -devnet and -server are specified"),
QT_TRANSLATE_NOOP("monoeci-core", "<category> can be:"),
...
QT_TRANSLATE_NOOP("monoeci-core", "Allow RFC1918 addresses to be relayed and connected to (default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "Already have that input."),
QT_TRANSLATE_NOOP("monoeci-core", "Always query for peer addresses via DNS lookup (default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("monoeci-core", "Attempt to recover private keys from a corrupt wallet on startup"),
...
QT_TRANSLATE_NOOP("monoeci-core", "Copyright (C)"),
...
QT_TRANSLATE_NOOP("monoeci-core", "Do not load the wallet and disable wallet RPC calls"),
QT_TRANSLATE_NOOP("monoeci-core", "Do you want to rebuild the block database now?"),
QT_TRANSLATE_NOOP("monoeci-core", "Done loading"),
QT_TRANSLATE_NOOP("monoeci-core", "ERROR! Failed to create automatic backup"),
QT_TRANSLATE_NOOP("monoeci-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("monoeci-core", "Enable publish hash transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("monoeci-core", "Enable publish hash transaction in <address>"),
QT_TRANSLATE_NOOP("monoeci-core", "Enable publish raw block in <address>"),
QT_TRANSLATE_NOOP("monoeci-core", "Enable publish raw transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("monoeci-core", "Enable publish raw transaction in <address>"),
...
QT_TRANSLATE_NOOP("monoeci-core", "Error loading %s"),
QT_TRANSLATE_NOOP("monoeci-core", "Error loading %s: Wallet corrupted"),
QT_TRANSLATE_NOOP("monoeci-core", "Error loading %s: Wallet requires newer version of %s"),
...
QT_TRANSLATE_NOOP("monoeci-core", "Error upgrading chainstate database"),
QT_TRANSLATE_NOOP("monoeci-core", "Error"),
QT_TRANSLATE_NOOP("monoeci-core", "Error: A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("monoeci-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("monoeci-core", "Failed to create backup %s!"),
...
QT_TRANSLATE_NOOP("monoeci-core", "Failed to find mixing queue to join"),
...
QT_TRANSLATE_NOOP("monoeci-core", "Failed to start a new mixing queue"),
...
QT_TRANSLATE_NOOP("monoeci-core", "Found enough users, signing ..."),
QT_TRANSLATE_NOOP("monoeci-core", "How many blocks to check at startup (default: %u, 0 = all)"),
QT_TRANSLATE_NOOP("monoeci-core", "Importing..."),
QT_TRANSLATE_NOOP("monoeci-core", "Imports blocks from external blk000??.dat file on startup"),
QT_TRANSLATE_NOOP("monoeci-core", "Include IP addresses in debug output (default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "Incompatible mode."),
...
QT_TRANSLATE_NOOP("monoeci-core", "Initialization sanity check failed. %s is shutting down."),
...
QT_TRANSLATE_NOOP("monoeci-core", "Invalid -onion address: '%s'"),
QT_TRANSLATE_NOOP("monoeci-core", "Invalid -proxy address: '%s'"),
QT_TRANSLATE_NOOP("monoeci-core", "Invalid amount for -%s=<amount>: '%s'"),
QT_TRANSLATE_NOOP("monoeci-core", "Invalid amount for -fallbackfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("monoeci-core", "Invalid amount for -paytxfee=<amount>: '%s' (must be at least %s)"),
QT_TRANSLATE_NOOP("monoeci-core", "Invalid masternodeprivkey. Please see documenation."),
QT_TRANSLATE_NOOP("monoeci-core", "Invalid netmask specified in -whitelist: '%s'"),
QT_TRANSLATE_NOOP("monoeci-core", "Invalid port detected in masternode.conf"),
QT_TRANSLATE_NOOP("monoeci-core", "Invalid script detected."),
QT_TRANSLATE_NOOP("monoeci-core", "Invalid spork address specified with -sporkaddr"),
QT_TRANSLATE_NOOP("monoeci-core", "KeePassHttp id for the established association"),
QT_TRANSLATE_NOOP("monoeci-core", "KeePassHttp key for AES encrypted communication with KeePass"),
QT_TRANSLATE_NOOP("monoeci-core", "Keep N XMCC anonymized (%u-%u, default: %u)"),
...
QT_TRANSLATE_NOOP("monoeci-core", "Loading wallet... (%3.2f %%)"),
QT_TRANSLATE_NOOP("monoeci-core", "Loading wallet..."),
QT_TRANSLATE_NOOP("monoeci-core", "Location of the auth cookie (default: data dir)"),
QT_TRANSLATE_NOOP("monoeci-core", "Lock is already in place."),
QT_TRANSLATE_NOOP("monoeci-core", "Lock masternodes from masternode configuration file (default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("monoeci-core", "Masternode cache is empty, skipping payments and governance cache..."),
QT_TRANSLATE_NOOP("monoeci-core", "Masternode options:"),
QT_TRANSLATE_NOOP("monoeci-core", "Masternode queue is full."),
QT_TRANSLATE_NOOP("monoeci-core", "Masternode:"),
QT_TRANSLATE_NOOP("monoeci-core", "Maximum per-connection receive buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "Maximum per-connection send buffer, <n>*1000 bytes (default: %u)"),
...
QT_TRANSLATE_NOOP("monoeci-core", "Not compatible with existing transactions."),
QT_TRANSLATE_NOOP("monoeci-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("monoeci-core", "Not enough funds to anonymize."),
QT_TRANSLATE_NOOP("monoeci-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("monoeci-core", "Number of automatic wallet backups (default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
QT_TRANSLATE_NOOP("monoeci-core", "Options:"),
QT_TRANSLATE_NOOP("monoeci-core", "Password for JSON-RPC connections"),
QT_TRANSLATE_NOOP("monoeci-core", "Port: %d"),
QT_TRANSLATE_NOOP("monoeci-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "Print this help message and exit"),
QT_TRANSLATE_NOOP("monoeci-core", "Print version and exit"),
QT_TRANSLATE_NOOP("monoeci-core", "PrivateSend is idle."),
QT_TRANSLATE_NOOP("monoeci-core", "PrivateSend options:"),
QT_TRANSLATE_NOOP("monoeci-core", "PrivateSend request complete:"),
QT_TRANSLATE_NOOP("monoeci-core", "PrivateSend request incomplete:"),
QT_TRANSLATE_NOOP("monoeci-core", "Prune cannot be configured with a negative value."),
...
QT_TRANSLATE_NOOP("monoeci-core", "Relay non-P2SH multisig (default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "Rescan the block chain for missing wallet transactions on startup"),
QT_TRANSLATE_NOOP("monoeci-core", "Rescanning..."),
QT_TRANSLATE_NOOP("monoeci-core", "Run in the background as a daemon and accept commands"),
QT_TRANSLATE_NOOP("monoeci-core", "Send trace/debug info to console instead of debug.log file"),
QT_TRANSLATE_NOOP("monoeci-core", "Send trace/debug info to debug.log file (default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "Send transactions as zero-fee transactions if possible (default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "Session not complete!"),
QT_TRANSLATE_NOOP("monoeci-core", "Session timed out."),
QT_TRANSLATE_NOOP("monoeci-core", "Set database cache size in megabytes (%d to %d, default: %d)"),
QT_TRANSLATE_NOOP("monoeci-core", "Set key pool size to <n> (default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "Set maximum block size in bytes (default: %d)"),
QT_TRANSLATE_NOOP("monoeci-core", "Set the masternode private key"),
QT_TRANSLATE_NOOP("monoeci-core", "Set the number of threads to service RPC calls (default: %d)"),
QT_TRANSLATE_NOOP("monoeci-core", "Show all debugging options (usage: --help -help-debug)"),
QT_TRANSLATE_NOOP("monoeci-core", "Shrink debug.log file on client startup (default: 1 when no -debug)"),
QT_TRANSLATE_NOOP("monoeci-core", "Signing transaction failed"),
QT_TRANSLATE_NOOP("monoeci-core", "Specify configuration file (default: %s)"),
QT_TRANSLATE_NOOP("monoeci-core", "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
QT_TRANSLATE_NOOP("monoeci-core", "Specify data directory"),
QT_TRANSLATE_NOOP("monoeci-core", "Specify masternode configuration file (default: %s)"),
QT_TRANSLATE_NOOP("monoeci-core", "Specify pid file (default: %s)"),
QT_TRANSLATE_NOOP("monoeci-core", "Specify wallet file (within data directory)"),
QT_TRANSLATE_NOOP("monoeci-core", "Specify your own public address"),
QT_TRANSLATE_NOOP("monoeci-core", "Spend unconfirmed change when sending transactions (default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "Starting network threads..."),
...
QT_TRANSLATE_NOOP("monoeci-core", "The source code is available from %s."),
QT_TRANSLATE_NOOP("monoeci-core", "The transaction amount is too small to pay the fee"),
QT_TRANSLATE_NOOP("monoeci-core", "The wallet will avoid paying less than the minimum relay fee."),
QT_TRANSLATE_NOOP("monoeci-core", "This is experimental software."),
QT_TRANSLATE_NOOP("monoeci-core", "This is not a Masternode."),
QT_TRANSLATE_NOOP("monoeci-core", "This is the minimum transaction fee you pay on every transaction."),
QT_TRANSLATE_NOOP("monoeci-core", "This is the transaction fee you will pay if you send a transaction."),
QT_TRANSLATE_NOOP("monoeci-core", "Threshold for disconnecting misbehaving peers (default: %u)"),
QT_TRANSLATE_NOOP("monoeci-core", "Too many %f denominations, removing."),
QT_TRANSLATE_NOOP("monoeci-core", "Tor control port password (default: empty)"),
QT_TRANSLATE_NOOP("monoeci-core", "Tor control port to use if onion listening enabled (default: %s)"),
QT_TRANSLATE_NOOP("monoeci-core", "Transaction amount too small"),
QT_TRANSLATE_NOOP("monoeci-core", "Transaction amounts must not be negative"),
QT_TRANSLATE_NOOP("monoeci-core", "Transaction created successfully."),
QT_TRANSLATE_NOOP("monoeci-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("monoeci-core", "Transaction has too long of a mempool chain"),
QT_TRANSLATE_NOOP("monoeci-core", "Transaction must have at least one recipient"),
QT_TRANSLATE_NOOP("monoeci-core", "Transaction not valid."),
QT_TRANSLATE_NOOP("monoeci-core", "Transaction too large for fee policy"),
QT_TRANSLATE_NOOP("monoeci-core", "Trying to connect..."),
QT_TRANSLATE_NOOP("monoeci-core", "Unable to bind to %s on this computer (bind returned error %s)"),
QT_TRANSLATE_NOOP("monoeci-core", "Unable to bind to %s on this computer. %s is probably already running."),
QT_TRANSLATE_NOOP("monoeci-core", "Unable to sign spork message, wrong key?"),
QT_TRANSLATE_NOOP("monoeci-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("monoeci-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("monoeci-core", "Unknown response."),
QT_TRANSLATE_NOOP("monoeci-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("monoeci-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("monoeci-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("monoeci-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("monoeci-core", "Upgrade wallet to latest format on startup"),
QT_TRANSLATE_NOOP("monoeci-core", "Upgrading UTXO database"),
...
QT_TRANSLATE_NOOP("monoeci-core", "Use devnet chain with provided name"),
...
QT_TRANSLATE_NOOP("monoeci-core", "Wallet debugging/testing options:"),
QT_TRANSLATE_NOOP("monoeci-core", "Wallet is locked."),
QT_TRANSLATE_NOOP("monoeci-core", "Wallet needed to be rewritten: restart %s to complete"),
...
QT_TRANSLATE_NOOP("monoeci-core", "Warning: unknown new rules activated (versionbit %i)"),
...
QT_TRANSLATE_NOOP("monoeci-core", "ZeroMQ notification options:"),
QT_TRANSLATE_NOOP("monoeci-core", "no mixing available."),
QT_TRANSLATE_NOOP("monoeci-core", "see debug.log for details."),
};
