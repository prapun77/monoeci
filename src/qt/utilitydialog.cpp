    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  monoeci-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Monoeci in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XMCC, 0.1 XMCC, 1 XMCC and 10 XMCC -- sort of like the paper money you use every day.</li> \
