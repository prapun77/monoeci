...
static const CAmount GOVERNANCE_PROPOSAL_FEE_TX = (50*COIN);
...
static const int64_t GOVERNANCE_WATCHDOG_EXPIRATION_TIME = 2*60*60; //MONOECI watchdog backward compatibility
