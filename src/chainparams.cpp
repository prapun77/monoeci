...
public:
    CMainParams() {
        ...
        consensus.nSuperblockStartHash = uint256S("000000000000026bad04a634e054959b066dc3e1470e0c2c7b0e2f7084c7e0db");
        ...
        consensus.BIP65Height = 200000; // 00000000000005f84e47bde58a9298242c04e8e71018afc2dc593931cc841088
        consensus.BIP66Height = 200000; // 00000000000005f84e47bde58a9298242c04e8e71018afc2dc593931cc841088
        ...
        strSporkAddress = "MMjPYWGWtw8Z6m9D5WDYkxRa6PAM4NtUoH";
        ...
        checkpointData = (CCheckpointData) {
			...
			(  200000, uint256S("0x00000000000005f84e47bde58a9298242c04e8e71018afc2dc593931cc841088"))
        };

        chainTxData = ChainTxData{
            1517530583, // * UNIX timestamp of last known number of transactions
            266716,    // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        consensus.BIP65Height = 21111; // 0000039cf01242c7f921dcb4806a5994bc003b48c1973ae0c89b67809c2bb2ab
        consensus.BIP66Height = 21111; // 0000002acdd29a14583540cb72e1c5cc83783560e38fa7081495d474fe1671f7
...
public:
    CDevNetParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Monoeci: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Monoeci: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowKGWHeight = 4001; // nPowKGWHeight >= nPowDGWHeight means "no KGW"
        consensus.nPowDGWHeight = 4001;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("monoecievo.org",  "devnet-seed.monoecievo.org"));
