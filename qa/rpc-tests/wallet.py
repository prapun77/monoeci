...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 XMCC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 XMCC in block rewards plus fees, but
        ...
        # Send 100 XMCC with subtract fee from amount
        ...
        # Sendmany 100 XMCC with subtract fee from amount
