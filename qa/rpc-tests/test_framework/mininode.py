...
#
# NodeConn: an object which manages p2p connectivity to a monoeci node
...
# Objects that map to monoecid objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in monoecid indicates these should be deserialized as blocks
